<template>
  <div class="wedo-file-input">
    ...
    <div v-show="value" class="row pt-3">
      <div
        v-for="(item, index) of value"
        :key="'img-' + index"
        class="col-md-4 preview-wrapper mb-4"
      >
        <img :src="item" alt="Alt text here" class="preview" />
    ...
    <input type="file" multiple :name="name" @change="onImageChange" />
